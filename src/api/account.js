...
export const createEvent = params => axios.post(`http://localhost:12354/api/togethers/5d21900d0b1d6d4cac321b79/events`,params)
export const deleteEvent = key => axios.delete(`http://localhost:12354/api/togethers/5d21900d0b1d6d4cac321b79/events/${key}`)
